...
## 💭 13. 팀원 회고 (Retrospective)

### 김정재

수업에서 배운 내용을 실제 데이터에 적용하면서 이론으로 이해했던 과정을 더 깊이 이해할 수 있었습니다. 팀장으로서 팀원들과 의견을 조율하고, 예상대로 진행되지 않는 부분을 직접 수정하고 해결하며 프로젝트를 끝까지 완성한 경험이 기억에 남았습니다.

### 김영석

직관적인 B2B 대시보드와 What-If 시뮬레이터를 구현하면서 분석 결과를 실제 사용자가 이해하고 활용할 수 있는 형태로 전달하는 경험을 쌓았습니다. Git·GitHub 협업 체계를 운영하며 안정적인 코드 통합의 중요성을 배웠고, Streamlit의 세션 상태와 브라우저 캐싱 문제를 해결하는 과정에서 공통 UI와 스타일 관리 구조의 필요성을 체감했습니다.

### 김혜진

모델링을 담당하면서 결과를 여러 번 검토하고 의심하는 과정의 중요성을 느꼈으며, 팀원들이 서로 도움을 주고받으며 유기적으로 협업하는 경험을 할 수 있었습니다. 발표자료를 작성하며 청자가 이해하기 쉬운 전달 방식을 고민했고, 아쉬웠던 점을 다음 프로젝트의 성장과 자신감으로 이어갈 수 있는 계기가 되었습니다.

### 신가을

모델링을 진행하면서 머리로 이해한 흐름과 실제 수행 과정 사이에 차이가 있다는 것을 경험했고, 관점에 따라 모델 선정과 해석, 비즈니스 전략이 다양하게 도출될 수 있다는 점이 흥미로웠습니다. 촉박한 일정 속에서도 팀원들이 담당 분야를 넘어 프로젝트 전반에 의견과 아이디어를 제시하고 조율한 덕분에 프로젝트를 원활하게 마무리할 수 있었습니다.

> 팀원별 전체 회고와 상세한 경험은 [팀원 회고](docs/team_retrospective.md)에서 확인할 수 있습니다.
